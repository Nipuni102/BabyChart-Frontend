import 'package:babychart/tip_page.dart';
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            color: Color.fromARGB(255, 255, 248, 255),
            child: Column(
              children: [
                const Text(
                  'Age - Weight',
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color(0xFF9E64B4), // Year button color
                    ...
                    ElevatedButton(
                      onPressed: () {},
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF9E64B4),
                        shape: const StadiumBorder(),
                      ),
                      child: const Text(
                        'Year 2',
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFD9ACFD), // Button color
                shape: const StadiumBorder(),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Image.asset(
                        'assets/icon2.png', // Your image path
                        height: 35, // Adjust image size as needed
                        width: 35,
                      ),
                  ...
                  // Add arrow icon at the end of the button
                  const Icon(
